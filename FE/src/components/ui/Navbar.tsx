...
import { Anchor, Menu, X, LogOut, LayoutDashboard, ShoppingBag } from "lucide-react";
...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[85rem] items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        {/* Logo + Brand name */}
        ...
        <div className="flex items-center gap-x-4">
          {!token ? (
            ...
            <div className="hidden lg:flex items-center gap-x-4">
              {activeRole === 'buyer' && (
                <Link to="/buyer/cart" className="text-gray-500 hover:text-blue-600 transition-colors p-2 rounded-full hover:bg-blue-50">
          ...
          <div className="flex items-center gap-4 lg:hidden">
            {token && activeRole === 'buyer' && (
               <Link to="/buyer/cart" className="text-gray-600 hover:text-blue-600 transition-colors">
