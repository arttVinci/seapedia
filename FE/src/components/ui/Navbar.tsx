                ...
                <div className="hidden lg:flex items-center gap-x-4">
                  ...
                  {activeRole === "driver" && (
                    <div className="flex items-center pr-4 border-r border-gray-200">
                      <Link
                        to="/driver"
                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 transition-colors text-sm font-semibold"
                      >
                  ...
                  {activeRole === "admin" && (
                    <div className="flex items-center pr-4 border-r border-gray-200">
                      <Link
                        to="/admin"
                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-800 text-white hover:bg-gray-900 transition-colors text-sm font-semibold"
                      >
                              ...
                              {(!hasSellerRole ||
                                ...
                                <div className="pt-2 mt-2 border-t border-gray-50 flex flex-col gap-1">
                                  ...
                                  {!availableRoles.includes("driver") && (
                                    ...
                                    >
                                      <Truck className="h-4 w-4" /> Daftar Mitra
                                      Pengantar
                                    </button>
                                  )}
                                </div>
                  ...
                  {activeRole && user && (
                    <div className="relative" ref={dropdownRef}>
                      ...
                      {dropdownOpen && (
                        <div
                          className={`absolute right-0 mt-2 ${activeRole === "buyer" ? "w-[480px]" : "w-64"} bg-white border border-gray-200 rounded-xl shadow-xl z-50 animate-in fade-in slide-in-from-top-2 duration-200 overflow-hidden`}
                        >
                          ...
                          >
                            ...
                            <div
                              className={`${activeRole === "buyer" ? "w-[45%]" : "w-full"} py-2`}
                            >
                              {activeRole === "buyer" && (
                                <>
                                  <Link
          ...
          >
            <div className="px-4 py-4 space-y-2">
              <form
                ...
                className="relative w-full mb-4 md:hidden"
              >
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Search className="h-4 w-4 text-gray-400" />
                </div>
